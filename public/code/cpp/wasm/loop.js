...
var _push_block = Module['_push_block'] = makeInvalidEarlyAccess('_push_block');
var _startloop = Module['_startloop'] = makeInvalidEarlyAccess('_startloop');
var _free = makeInvalidEarlyAccess('_free');
var _malloc = makeInvalidEarlyAccess('_malloc');
var _stoploop = Module['_stoploop'] = makeInvalidEarlyAccess('_stoploop');
...
function assignWasmExports(wasmExports) {
  assert(typeof wasmExports['push_block'] != 'undefined', 'missing Wasm export: push_block');
  assert(typeof wasmExports['startloop'] != 'undefined', 'missing Wasm export: startloop');
  assert(typeof wasmExports['free'] != 'undefined', 'missing Wasm export: free');
  assert(typeof wasmExports['malloc'] != 'undefined', 'missing Wasm export: malloc');
  assert(typeof wasmExports['stoploop'] != 'undefined', 'missing Wasm export: stoploop');
  ...
  _push_block = Module['_push_block'] = createExportWrapper('push_block', 1);
  _startloop = Module['_startloop'] = createExportWrapper('startloop', 2);
  _free = createExportWrapper('free', 1);
  _malloc = createExportWrapper('malloc', 1);
  _stoploop = Module['_stoploop'] = createExportWrapper('stoploop', 0);
